...
dsy.add("0_19_11",["莞城街道","南城街道","东城街道","万江街道","石龙镇","石排镇","茶山镇","企石镇","桥头镇","东坑镇","横沥镇","常平镇","虎门镇","长安镇","沙田镇","厚街镇","寮步镇","大岭山镇","大朗镇","黄江镇","樟木头镇","谢岗镇","塘厦镇","塘厦镇","凤岗镇","麻涌镇","中堂镇","高埗镇","石碣镇","望牛墩镇","洪梅镇","道滘镇"])
dsy.add("0_19_12",["香洲区","斗门区","金湾区"]);
dsy.add("0_19_13",["石岐街道","东区街道","西区街道","南区街道","五桂山街道","中山火炬高技术产业开发区黄圃镇","南头镇","东凤镇","阜沙镇","小榄镇","东升镇","古镇镇","横栏镇","三角镇","民众镇","南朗镇","港口镇","大涌镇","沙溪镇","三乡镇","板芙镇","神湾镇","坦洲镇"]);
...
dsy.add("0_21",["海口市","三亚市","三沙市","儋州市","省直辖行政单位"]);
...
var s=["area-prv","area-city","area-block"];//三个select的name
var opt0 = ["请选择","请选择","请选择"];//初始值
function _init_area(){  //初始化函数
	for(i=0;i<s.length-1;i++){
	  document.getElementById(s[i]).onchange=new Function("change("+(i+1)+")");
