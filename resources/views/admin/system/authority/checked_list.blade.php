                ...
                <table class="table table-bordered table-striped table-hover" id="">
                    ...
                    @if(!empty($authorities))
                        @foreach($authorities as $topItem)
                            ...
                            @else
                                <tr>
                                    <td><input type="checkbox" name="auth_checked[]" class="first_level" value="{{ $topModel->ts_action }}" @if($topModel->is_checked)checked="checked"@endif/>&nbsp;&nbsp;{{ $topModel->name }}({{ $topModel->ts_action }})</td>
                                    <td rowspan="1"></td>
                                    <td rowspan="1"></td>
                                </tr>
                            @endif
