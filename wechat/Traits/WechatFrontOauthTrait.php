...
trait WechatFrontOauthTrait
{
    ...
    public function wechatUser()
    {
        ...
        $sessionUserInfoKey = SessionConfig::FRONT_USER_ID;
        $sessionUserKey = SessionConfig::FRONT_USER_INFO;
...
//            ]);
        ...
        if ($this->userId) {
            ...
            $httpTool->setSession($sessionUserInfoKey, $user);
        }
        return $user;
    }
